...
if GDAL:
    ...
    if not gdalDriver:
        GDAL = False
        print("GDAL installation has no support for HDF4, please use pyhdf for processing")
    ...
    def dayDownload(self, day, listFilesDown):
        ...
        for i in listFilesDown:
            ...
            if numFiles == 0:
                ...
                print(file_hdf + " does not exist in the directory, start downloading ...")
            # if one does exist
            elif numFiles == 1:
                ...
                if fileDown != oldFile[0]:
                    ...
                    print(file_hdf + " has a newer version, start downloading ...")
                else:
                    print(fileDown + " exists in the directory, skip ...")
            elif numFiles > 1:
